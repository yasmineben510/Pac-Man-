...
public class extLevel0 extends SuperPacmanArea {
	/// SuperPacman's initial position
	    ...
	    protected void createArea() {
	    	...
	    	Door door = new Door("superpacman/extLevel1",posDoor,Logic.TRUE,this,Orientation.UP,positionDoor,otherCellsDoor);
	    	registerActor(door);
